...
public class LegionfallBuildingPanel : MonoBehaviour
{
	...
	public void MakeContribution()
	{
		...
		MobileContribution contribution = ((LegionfallData.MobileContributionData)LegionfallData.legionfallDictionary[this.m_contributionID]).contribution;
		if (contribution.State == 1)
		{
			...
			mobilePlayerMakeContribution.ContributionID = contribution.ContributionID;
