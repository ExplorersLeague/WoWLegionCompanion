...
namespace WoWCompanionApp
{
	public class WowTextParser
	{
		...
		private void ParseSpellPoints()
		{
			...
			SpellEffectRec spellEffectRec2 = StaticDB.spellEffectDB.GetRecordsByParentID(this.m_spellID).FirstOrDefault((SpellEffectRec spellEffectRec) => spellEffectRec.EffectIndex == effectIndex);
			this.m_currentValue = ((spellEffectRec2 == null) ? 0 : spellEffectRec2.EffectBasePoints).ToString();
			this.AddNumericToken();
		}
