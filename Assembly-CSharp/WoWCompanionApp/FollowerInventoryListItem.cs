...
namespace WoWCompanionApp
{
	public class FollowerInventoryListItem : MonoBehaviour
	{
		...
		{
			WrapperFollowerEquipment? equipmentItem = this.m_equipmentItem;
			return equipmentItem != null;
		}

		public bool IsArmament()
		{
			WrapperFollowerArmamentExt? armamentItem = this.m_armamentItem;
			return armamentItem != null;
		}
		...
		{
			bool flag = (this.m_combatAllyChampion.Value.Flags & 4) != 0;
			bool flag2 = (this.m_combatAllyChampion.Value.Flags & 2) != 0;
			bool flag3 = this.m_combatAllyChampion.Value.CurrentMissionID != 0;
			bool flag4 = this.m_combatAllyChampion.Value.CurrentBuildingID != 0;
		...
		public void HandleTapUseItemButton()
		{
			...
			if (armamentItem != null)
			{
				Debug.Log(string.Concat(new object[]
				{
					...
					this.m_armamentItem.Value.ItemID,
					" for follower ",
			...
			else
			{
				...
				if (equipmentItem != null)
				{
					Debug.Log(string.Concat(new object[]
					{
						...
						this.m_equipmentItem.Value.ItemID,
						" for follower ",
						this.m_followerDetailView.GetCurrentFollower()
					}));
				...
				{
					WrapperGarrisonFollower? combatAllyChampion = this.m_combatAllyChampion;
					if (combatAllyChampion != null)
					{
