	...
	public class RPCMeterConfigParser
	{
		public static RPCMethodConfig ParseMethod(Tokenizer tokenizer)
		{
			...
			for (;;)
			{
				...
				{
					RPCMeterConfigParser.<>f__switch$mapC = new Dictionary<string, int>(11)
					{
						{
							"service_name:",
							0
				...
				int num;
				if (!RPCMeterConfigParser.<>f__switch$mapC.TryGetValue(text2, out num))
				{
					goto IL_1E6;
				}
				switch (num)
		...
		public static RPCMeterConfig ParseConfig(string str)
		{
			...
			for (;;)
			{
				...
				{
					RPCMeterConfigParser.<>f__switch$mapD = new Dictionary<string, int>(5)
					{
						{
							"method",
							0
				...
				int num;
				if (!RPCMeterConfigParser.<>f__switch$mapD.TryGetValue(text2, out num))
				{
					goto IL_108;
				}
				switch (num)
